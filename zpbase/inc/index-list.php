	...
	<div class="container" id="middle">
		<div class="row">
			<div id="content">
				...
				<div class="image-list albums">
					<?php while (next_album()): ?>
					<div class="image-list-unit">
						...
						<p class="album-desc"><?php echo truncate_string(strip_tags(getAlbumDesc()),500,'...'); ?></p>
						<div class="image-list-separator"></div>
					</div>
					<?php endwhile; ?>
				</div>
				<?php 
